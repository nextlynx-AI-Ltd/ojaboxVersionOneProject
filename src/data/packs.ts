...
export const allItems: FoodItem[] = [
  ...
  { id: "garri", name: "Garri", unit: "5kg bag", pricePerUnit: 1800, category: "staples", image: "/assets/items/garri.jpg", description: "Garri for eba or soaking" },
  { id: "beans", name: "Beans", unit: "2.5kg bag", pricePerUnit: 4000, category: "staples", image: "/assets/items/beans.jpg", description: "Clean beans" },
  ...
  { id: "elubo", name: "Yam Flour (Elubo)", unit: "5kg bag", pricePerUnit: 7500, category: "staples", image: "/assets/items/elubo.jpg", description: "Ground yam flour for amala" },
  { id: "semo", name: "Semovita", unit: "1kg pack", pricePerUnit: 1800, category: "staples", image: "/assets/items/semo.jpg", description: "Smooth semovita for swallow" },

  // Quick Foods
  { id: "spaghetti", name: "Spaghetti", unit: "pack", pricePerUnit: 950, category: "quick-foods", image: "/assets/items/spaghetti.jpg", description: "Quality spaghetti pasta" },
  { id: "macaroni", name: "Macaroni", unit: "pack", pricePerUnit: 1000, category: "quick-foods", image: "/assets/items/macaroni.jpg", description: "Elbow macaroni pasta" },
  ...
  // Cooking Essentials
  { id: "salt", name: "Salt", unit: "1 pack", pricePerUnit: 500, category: "cooking-essentials", image: "/assets/items/salt.jpg", description: "Iodized table salt" },
  ...
  { id: "eggs", name: "Eggs", unit: "crate (6)", pricePerUnit: 1400, category: "extras", image: "/assets/items/eggs.jpg", description: "Fresh chicken eggs" },
